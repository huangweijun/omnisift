(function () {
  ...
  var copy = {
    en: {
      ...
      "home.positioning.lead": "OmniSift starts where ideas actually show up: inside Safari, WeChat, Xiaohongshu, X, Notes, and screenshots. It focuses on capture, structure, visibility, and next-step guidance.",
      "home.privacy.kicker": "Privacy boundary",
      "home.privacy.title": "Local-first storage, clear cloud processing.",
      "home.privacy.lead": "OmniSift does not claim fully local processing. Text you share is sent to OmniSift cloud processing, and the resulting cards are stored on your device.",
      ...
      "home.privacy.local.body": "Processed knowledge cards are stored locally on device. Text is sent to the OmniSift cloud only during processing.",
      ...
      "first.after.lead": "Once the Safari capture works, try sharing an assistant answer, an article paragraph, a note, or a screenshot. OmniSift is designed for those scattered moments.",
      ...
      "use.ai.title": "Save AI assistant answers",
      ...
      "faq.q.ai": "Can OmniSift save AI assistant answers?",
    ...
    zh: {
      ...
      "home.workflow.lead": "知漏适合保存那些不在笔记软件里出现的想法：智能助手回答、网页段落、聊天消息、小红书链接、截图和复制图片。",
      ...
      "home.positioning.lead": "知漏从想法真正出现的地方开始：Safari、微信、小红书、X、备忘录和截图。它聚焦采集、结构化、可视化和下一步指引。",
      "home.privacy.kicker": "隐私边界",
      "home.privacy.title": "本地优先存储，清晰说明云端处理。",
      "home.privacy.lead": "知漏不声称完全本地处理。你分享的文本会发送到知漏云端处理，生成的卡片保存在设备本地。",
      ...
      "home.privacy.local.body": "处理后的知识卡片保存在设备本地；文本仅在处理时发送到云端处理。",
      ...
      "first.after.lead": "Safari 捕获成功后，可以试着分享智能助手回答、文章段落、备忘录或截图。知漏就是为这些分散时刻设计的。",
      "first.after.ai": "保存智能助手回答",
      ...
      "compare.readwise.diff": "知漏接受更广泛的 iOS 输入，包括智能助手回答、普通文本片段、链接、文章和截图。",
      ...
      "compare.positioning.lead": "理想的知漏时刻不是空白页，而是聊天里的一句话、浏览器里的有用段落、某个 App 的截图，或一段不想丢掉的智能助手回答。",
      "compare.bullet.capture": "通过 iOS 分享菜单跨 App 捕获。",
      "compare.bullet.structure": "知漏自动生成标题、摘要、高亮、标签、实体和语义关系。",
      ...
      "changelog.lead": "这里记录公开产品更新，方便用户、搜索引擎和 智能问答引擎理解产品变化。",
      ...
      "changelog.v1.ai": "使用云端处理生成标题、摘要、高亮、标签、实体、语义关系；原文可读时整理为 Markdown。",
      "changelog.v1.graph": "浏览已保存卡片、关联洞察、主题星座、知识星图和罗盘指引。",
      "changelog.v1.pricing": "免费版每日 5 次云端处理。专业版设计为每日 50 次，App Store 订阅可用后首发计划价格为 ¥12/月或 ¥68/年。",
