(function () {
  ...
  var copy = {
    en: {
      ...
      "footer.tagline": "AI cross-app snippet capture for iOS.",
      "footer.home": "Home",
      ...
      "home.eyebrow": "iOS Share Sheet + AI knowledge cards",
      "home.title": "OmniSift",
      "home.hero": "Save text, links, articles, and screenshots from any app. OmniSift turns scattered snippets into structured knowledge cards with summaries, highlights, tags, entities, and connections.",
      ...
      "home.workflow.title": "One iOS share action becomes a knowledge card.",
      "home.workflow.lead": "OmniSift is built for ideas that appear outside your notes app: AI answers, web paragraphs, chat messages, screenshots, and saved links.",
      "home.step1.title": "Share from any app",
      "home.step2.title": "AI distills the snippet",
      "home.step3.title": "Review and connect",
      "home.positioning.kicker": "Positioning",
      "home.positioning.title": "Not another place to type notes.",
      "home.positioning.lead": "OmniSift starts where ideas actually show up: inside ChatGPT, Claude, Safari, WeChat, X, Notes, and screenshots. It focuses on capture, structure, and recall.",
      ...
      "changelog.v1.body": "OmniSift is preparing its first iOS release. The first version focuses on Share Extension capture, AI-powered knowledge card generation, local card storage, and a personal knowledge graph experience.",
      "changelog.v1.capture": "Capture text, links, articles, and screenshots through the iOS Share Sheet.",
      "changelog.v1.ai": "Generate card titles, summaries, highlights, tags, entities, and semantic relations with cloud AI.",
      "changelog.v1.graph": "Browse saved cards, related insights, topic clusters, and knowledge graph views.",
    ...
    zh: {
      ...
      "nav.privacy": "隐私",
      "nav.launch": "上线提醒",
      "footer.tagline": "iOS 跨应用 AI 知识碎片收集。",
      "footer.home": "首页",
      ...
      "home.eyebrow": "iOS 分享菜单 + AI 知识卡片",
      "home.title": "知漏",
      "home.hero": "从任意 App 保存文本、链接、文章和截图。知漏会把零散内容整理成带有摘要、高亮、标签、实体和关联的结构化知识卡片。",
      "home.proof.account": "无需账号",
      "home.proof.local": "卡片本地存储",
      "home.proof.tracking": "无追踪与分析",
      "home.workflow.kicker": "使用方式",
      "home.workflow.title": "一次系统分享，生成一张知识卡片。",
      "home.workflow.lead": "知漏适合保存那些不在笔记软件里出现的想法：AI 回答、网页段落、聊天消息、截图和链接。",
      "home.step1.title": "从任意 App 分享",
      "home.step2.title": "AI 提炼片段",
      "home.step3.title": "回顾并建立关联",
      "home.positioning.kicker": "产品定位",
      "home.positioning.title": "不是另一个让你手写笔记的地方。",
      "home.positioning.lead": "知漏从想法真正出现的地方开始：ChatGPT、Claude、Safari、微信、X、备忘录和截图。它聚焦捕获、结构化和回顾。",
      ...
      "changelog.v1.body": "知漏正在准备第一个 iOS 版本。首发版本聚焦分享扩展采集、AI 知识卡片生成、本地卡片存储和个人知识图谱体验。",
      "changelog.v1.capture": "通过 iOS 分享菜单采集文本、链接、文章和截图。",
      "changelog.v1.ai": "使用云端 AI 生成卡片标题、摘要、高亮、标签、实体和语义关系。",
      "changelog.v1.graph": "浏览已保存卡片、关联洞察、主题簇和知识图谱视图。",
